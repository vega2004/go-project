...
func (r *userRepository) Create(user *models.User) error {
	...
	// Crear perfil de usuario asociado (datos extra)
	_, err = r.db.Exec(`
...
// ============================================
// UPDATE - Actualizar usuario (sin contraseña)
// ============================================
...
// ============================================
// DELETE - Eliminar usuario (con validaciones)
// ============================================
func (r *userRepository) Delete(id int) error {
	...
	// Verificar si es administrador y no es el último
	if user.PerfilID == 1 {
...
// ============================================
// FIND BY ID - Buscar usuario por ID (con foto)
// ============================================
func (r *userRepository) FindByID(id int) (*models.User, error) {
	user := &models.User{}
	query := `
		SELECT u.id, u.name, u.email, u.phone, u.perfil_id, u.activo, u.created_at, u.updated_at,
...
// ============================================
// FIND BY EMAIL - Buscar usuario por email (con foto)
// ============================================
...
func (r *userRepository) FindAll(filter *models.UserFilter) (*models.UserPaginatedResponse, error) {
	...
	if filter.Activo != "" {
		activoBool := filter.Activo == "true"
		where = append(where, fmt.Sprintf("u.activo = $%d", argPos))
		args = append(args, activoBool)
		argPos++
	}
	...
	for rows.Next() {
		...
		err := rows.Scan(
			...
			&u.PerfilID, &u.Activo, &u.CreatedAt,
			&u.PerfilNombre, &u.FotoPath,
		)
		if err != nil {
...
// ============================================
// UPDATE STATUS - Activar/Desactivar usuario
// ============================================
...
// ============================================
// IS EMAIL UNIQUE - Verificar si el email es único
// ============================================
...
// ============================================
// COUNT ACTIVE ADMINS - Contar administradores activos
// ============================================
...
// ============================================
// EXISTS BY ID - Verificar si existe un usuario
// ============================================
...
// ============================================
// GET USER WITH PROFILE - Obtener usuario con datos completos
// ============================================
